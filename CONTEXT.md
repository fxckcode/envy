...
- **Compare matrix**: Presence/difference grid across all environments; never shows secret cleartext; non-secret divergent values may appear in cleartext.
...
- **Approval request**: Agent-proposed write to a protected target awaiting Allow once / Allow for project / Deny. Modal masks prior secret values; proposed new value is shown for informed approval.
